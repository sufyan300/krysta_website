export default function FilingPage() {
  return (
    <div className="min-h-screen">
      ...
      <section className="bg-gradient-to-b from-[#f0f4ff] via-[#d9e6ff] to-[#0066ff] py-32">
        <div className="container mx-auto px-4">
          <div className="text-center">
            <p className="text-gray-800 mb-4">Product / Autofile</p>
            <h1 className="text-5xl md:text-6xl font-bold mb-6">
              Automate sales tax filing <br />
              and remittance
            </h1>
            <p className="text-xl text-gray-800 max-w-3xl mx-auto mb-8">
              Krysta's AutoFile automates state sales tax filing, ensuring accuracy and timely submissions, so you can
              focus on growth
            </p>
          </div>
        </div>
      ...
      {/* Minimize human error Section */}
      <section className="py-20 bg-gray-50">
        <div className="container mx-auto px-4">
          <div className="grid md:grid-cols-2 gap-12 items-center">
            <div>
              <h2 className="text-4xl font-bold mb-6">Minimize human error</h2>
              <p className="text-lg text-gray-700 mb-8">
                Krysta automates the process by transferring your state report to your sales tax return, eliminating the
                need to manually search for errors, so you can submit with confidence.
              </p>
            </div>
      ...
      {/* Never miss a filing due date Section */}
      <section className="py-20 bg-white">
        <div className="container mx-auto px-4">
          <div className="grid md:grid-cols-2 gap-12 items-center">
            <div>
              <h2 className="text-4xl font-bold mb-6">Never miss a filing due date</h2>
              <p className="text-lg text-gray-700 mb-8">
                With filings due in multiple states and varying deadlines, it's easy to miss important dates. Krysta's
                AutoFile automatically submits returns and remittances to enrolled states, ensuring you never miss a
                deadline.
              </p>
            </div>
            <div className="bg-blue-100 p-8 rounded-lg">
      ...
      {/* Streamline processing and reduce costs Section */}
      <section className="py-20 bg-gray-50">
        <div className="container mx-auto px-4">
          <div className="grid md:grid-cols-2 gap-12 items-center">
            <div className="bg-blue-100 p-8 rounded-lg">
            ...
            <div>
              <h2 className="text-4xl font-bold mb-6">Streamline processing and reduce costs</h2>
              <p className="text-lg text-gray-700 mb-8">
                Your paperwork grows exponentially as you collect sales tax in more states. Krysta not only handles the
                data input, but also prepares filings according to each state's specific requirements, allowing you to
