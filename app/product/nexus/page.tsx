export default function NexusPage() {
  return (
    <div className="min-h-screen">
      ...
      <section className="bg-gradient-to-b from-[#f0f4ff] via-[#d9e6ff] to-[#0066ff] py-32">
        <div className="container mx-auto px-4">
          <div className="text-center">
            <p className="text-gray-800 mb-4">Product / Nexus Insights</p>
            <h1 className="text-5xl md:text-6xl font-bold mb-6">
              Track economic nexus <br />
              across states
            </h1>
            <p className="text-xl text-gray-800 max-w-3xl mx-auto mb-8">
              Krysta simplifies economic nexus with a dashboard and alerts to track exposure and notify you when state
      ...
      {/* Set up proactive notifications Section */}
      <section className="py-20 bg-gray-50">
        <div className="container mx-auto px-4">
          <div className="grid md:grid-cols-2 gap-12 items-center">
            <div>
              <h2 className="text-4xl font-bold mb-6">Set up proactive notifications for nexus changes</h2>
      ...
      {/* Simplify the complexities Section */}
      <section className="py-20 bg-white">
        <div className="container mx-auto px-4">
          <div className="grid md:grid-cols-2 gap-12 items-center">
            <div>
              <h2 className="text-4xl font-bold mb-6">Simplify the complexities of economic nexus</h2>
              <p className="text-lg text-gray-700 mb-8">
                Your sales tax obligations depend on your physical and economic nexus activity, with each state setting
                its own threshold. Krysta's Nexus Insights Dashboard simplifies the process, showing you which states
                require sales tax collection based on your activity, eliminating the need for manual workflows.
              </p>
            </div>
            <div className="bg-blue-100 p-8 rounded-lg">
              <div className="bg-white p-6 rounded-lg shadow-sm">
      ...
      {/* Know when you're approaching a nexus threshold Section */}
      <section className="py-20 bg-gray-50">
        <div className="container mx-auto px-4">
          <div className="grid md:grid-cols-2 gap-12 items-center">
            <div className="bg-blue-100 p-8 rounded-lg">
            ...
            <div>
              <h2 className="text-4xl font-bold mb-6">Know when you're approaching a nexus threshold</h2>
              <p className="text-lg text-gray-700 mb-8">
