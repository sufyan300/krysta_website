export default function IntegrationsPage() {
  return (
    <div className="min-h-screen">
      ...
      <section className="bg-gradient-to-b from-[#f0f4ff] via-[#d9e6ff] to-[#0066ff] py-32">
        <div className="container mx-auto px-4">
          <div className="text-center">
            <p className="text-gray-800 mb-4">Product / Integrations</p>
            <h1 className="text-5xl md:text-6xl font-bold mb-6">
              Integrate with e-commerce <br />
              and ERP platforms
            </h1>
            <p className="text-xl text-gray-800 max-w-3xl mx-auto mb-8">
              Krysta's cloud API integrates easily with systems like Amazon and Shopify for quick sales tax calculation
              at checkout.
            </p>
          </div>
        </div>
      ...
      {/* Customize your integration Section */}
      <section className="py-20 bg-gray-50">
        <div className="container mx-auto px-4">
          <div className="grid md:grid-cols-2 gap-12 items-center">
            <div>
              <h2 className="text-4xl font-bold mb-6">Customize your integration with the Krysta API</h2>
              <p className="text-lg text-gray-700 mb-8">
                If your needs exceed our prebuilt solutions, Krysta's API allows you to build your own. With detailed
                documentation and open-source clients on GitHub, getting started is simple — just use your API token.
              </p>
            </div>
      ...
      {/* Integrate Krysta in minutes Section */}
      <section className="py-20 bg-white">
        <div className="container mx-auto px-4">
          <div className="grid md:grid-cols-2 gap-12 items-center">
            <div className="bg-blue-100 p-8 rounded-lg">
            ...
            <div>
              <h2 className="text-4xl font-bold mb-6">Integrate Krysta in minutes</h2>
              <p className="text-lg text-gray-700 mb-8">
                All our integrations are easy to configure and provide a great user experience directly from the Krysta
                dashboard.
              </p>
            </div>
          </div>
      ...
      <section className="py-20 bg-gray-50">
        <div className="container mx-auto px-4">
          <div className="grid md:grid-cols-2 gap-12 items-center">
            <div>
              <h2 className="text-4xl font-bold mb-6">Get peace of mind with tested and certified code</h2>
              <p className="text-lg text-gray-700 mb-8">
                Whether an integration is built by us or our partners, we ensure each one meets the highest quality
                standards. We test for comprehensive functionality, supporting the entire sales tax process, from
                calculations to reporting.
              </p>
            </div>
            <div className="bg-blue-100 p-8 rounded-lg">
              <div className="bg-white p-6 rounded-lg shadow-sm">
